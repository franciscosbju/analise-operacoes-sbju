...
def highlight_pax(value):
    if isinstance(value, int) and value > 484:
        return 'color: red;'
    return ''
...
if uploaded_file is not None:
    try:
        ...
        styled_arrivals = consecutive_arrivals.style.applymap(highlight_pax, subset=['PAX'])
        ...
        styled_departures = consecutive_departures.style.applymap(highlight_pax, subset=['PAX'])
